...
const ProjectSection = () => {
  ...
  return (
    <div className='size-full p-10'>
      ...
      <div className="flex flex-wrap gap-4 justify-center xl:justify-between my-20">
...
const ProjectCard = ({ title, img, type, topic }) => {
  return (
    <div className="relative w-[25rem] h-[32.8rem] flex flex-col justify-between items-end group cursor-pointer">
      ...
      <div className="w-[14rem] md:w-[18rem] h-[8rem] absolute top-0 left-0 bg-charcoal rounded-tl-xl rounded-tr-4xl
