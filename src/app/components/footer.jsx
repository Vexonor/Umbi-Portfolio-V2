  ...
  return (
    <>
      <footer className="size-full py-10">
        <div className='size-full border-y-4 flex flex-col justify-center border-black px-10 md:px-20 py-10 md:py-20'>
          <div className='w-full h-5/6'>
            <h2 className='font-semibold text-2xl'>If u need us just contact us</h2>
            <div className='flex flex-wrap my-5 gap-4'>
              <a href="https://www.instagram.com/umbi_dev/" target="_blank" className='border-2 border-black rounded-lg p-2 group'>
              ...
              <a href="https://www.linkedin.com/company/umbiteams/" target="_blank" className='border-2 border-black rounded-lg p-2 group'>
              ...
              <a href="https://mail.google.com/mail/?view=cm&fs=1&to=umbidev@gmail.com" target="_blank" className='border-2 border-black rounded-lg p-2 group'>
          ...
          <div className='flex justify-between items-center'>
            <h2 className='font-semibold md:text-2xl'>See u on ur project</h2>
            <h2 className='font-semibold md:text-2xl'>Umbi_dev</h2>
          </div>
        </div>
      </footer>
